...
**שאלה:**
צור טבלה בשם `members` ללא שימוש ב־AUTOINCREMENT, והוסף שלוש רשומות עם מזהים ידניים. לאחר מכן, שנה את מבנה הטבלה כך שהמזהה יעבוד עם `AUTOINCREMENT`, והכנס עוד שלוש רשומות ללא ציון מזהה.
